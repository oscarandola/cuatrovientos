...
//No utilizar PreparedStatements es una muy mala práctia de programación
if (isset($_POST["name"]) && $_POST["name"] != "") {
    $sql = "INSERT into creature (name, description, avatar, attackPower, lifeLevel, weapon) 
				values ('" . $_POST["name"] . "','" . $_POST["description"] . "','" . $_POST['avatar'] . "',"
             . $_POST["attackPower"] . "," . $_POST["lifeLevel"] . ",'" . $_POST['weapon'] . "')";
    
    //Se ejecuta la query
    mysql_query($sql);
    
    //Redirigimos al listado otra vez
